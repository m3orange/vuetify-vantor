...
<v-col lg="7" md="12" sm="12" class="hero-left-col">
  ...
  <div class="text-block bg-with-corners">
    ...
    <div class="hero-paragraph">
        Atlas is the design system used across all of our products. This repository contains Atlas’s documentation, including usage guidelines, product specifications, and working live code previews.
    </div>
...
.bg-with-corners{
   background-image: 
    url(../assets/images/dashboard/bg-corners-01.png),
        url(../assets/images/dashboard/bg-corners-02.png),
            url(../assets/images/dashboard/bg-corners-03.png),
                url(../assets/images/dashboard/bg-corners-04.png);
